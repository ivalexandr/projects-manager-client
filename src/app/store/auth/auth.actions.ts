...
export const setRegisterData = createAction('[Auth]: Set register data', props<CreateUserDto>());
...
export const setLoginData = createAction('[Auth]: Set login data', props<LoginUserDto>());
